...
document.addEventListener("visibilitychange", function () {
  if (document.visibilityState === "visible") {
    document.title = "Portfolio | Sushant Chavan";
    $("#favicon").attr("href", "assests/images/Sushant Chavan.png");
  } else {
...
var typed = new Typed(".typing-text", {
  strings: ["Web Development", "App Development", "AI/ML", "Cyber Security"],
  loop: true,
  typeSpeed: 50,
  backSpeed: 25,
  backDelay: 500,
...
$("#contact-form").submit(function (event) {
  ...
  event.preventDefault();
  emailjs.init("KlmkComE_gQN0dJDs");
  console.log("form submitted");
  emailjs.sendForm("service_5ogpa7s", "template_j8cmhuq", "#contact-form").then(
    function (response) {
